...
<script>
	function save_go(frm) {
		frm.action = "QNA?type=QNAupdateOK";
		frm.submit();
	}
</script>
<style>
					...
					<tr>
						<div class="form-group">
							<label for="exampleFormControlInput1">제목</label> <input
								...
								id="exampleFormControlInput1" value="${BoardVO.getTitle() }">
						</div>
					</tr>
				...
				<tfoot>
					<tr>
						<td colspan="2"><input class="btn btn-info" type="button"
							...
							type="hidden" name="bb_idx" value="${BoardVO.getBb_idx() }">
					</tr>
				</tfoot>
			</table>
		</form>
