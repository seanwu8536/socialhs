					...
					<tr>
						<div class="form-group">
							...
							<textarea name="content" class="form-control"
								id="exampleFormControlTextarea1" rows="10">${BoardVO.getContent() }</textarea>
						</div>
					</tr>
				</tbody>
				<tfoot>
					<tr>
						<td colspan="2"><input type="button" class="btn btn-warning"
							value="수정 완료" onclick="save_go(this.form)"> <input
							type="reset" class="btn btn-warning" value="초기화"> <input
							type="hidden" name="bb_idx" value="${BoardVO.getBb_idx() }"></td>
					</tr>
				</tfoot>
			</table>
		</form>
