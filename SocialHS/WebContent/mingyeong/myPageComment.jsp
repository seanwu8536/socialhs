...
<%
	...
	p.setTotalRecord(dao.getTotCommentCnt(id));
...
<div id="mypage"
	...
	<ul id ="infohead" class="nav mx-auto my-2">
		<li class="nav-item"><a href="MypageController?type=moreWrite&cPage=1">내가 쓴 게시글</a>&nbsp;|&nbsp;</li>
		<li class="nav-item"><a href="MypageController?type=moreComment&cPage=1">
			<font color="orangered"><b>내가 쓴 댓글</b></font></a>&nbsp;|&nbsp;</li>
